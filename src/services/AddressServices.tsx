...
export const getAllAddress = async (payload?:any,onSuccess?:(res:any)=>void,onError?:(res:any)=>void)=>{
    try {
...
export const addAddress = async (payload?:any,onSuccess?:(res:any)=>void,onError?:(res:any)=>void)=>{
    try {
...
export const deleteAddress = async (id?:string,onSuccess?:(res:any)=>void,onError?:(res:any)=>void)=>{
    try {
