...
export const deleteCart =async (id:string,onSuccess:(res:any)=>void,onError?:(res:any)=>void)=>{
    try {
...
export const updateCart =async (id:string,payload:any,onSuccess:(res:any)=>void,onError:(res:any)=>void)=>{
    try {
...
export const onCheckoutCart =async (payload:any,onSuccess:(res:any)=>void,onError:(res:any)=>void)=>{
    try {
