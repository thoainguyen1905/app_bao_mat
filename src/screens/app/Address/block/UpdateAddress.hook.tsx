...
export function useModel(props: any) {
  ...
  useEffect(() => {
    ...
    if (params?.item) {
      ...
      setFieldValue(
        'districtName',
        params?.item?.detailAddress?.district?.name,
      );
      ...
      setFieldValue(
        'defaultAddress',
        params?.item?.defaultAddress === 0 ? false : true,
      );
  ...
  const SignupSchema = Yup.object().shape({
    name: Yup.string().min(5, t('validInfo')).required(t('validInfo')),
    phone: Yup.string().min(5, t('validInfo')).required(t('validInfo')),
    address: Yup.string().min(5, t('validInfo')).required(t('validInfo')),
    cityName: Yup.string().min(5, t('validInfo')).required(t('validInfo')),
    districtName: Yup.string().min(5, t('validInfo')).required(t('validInfo')),
    wardName: Yup.string().min(5, t('validInfo')).required(t('validInfo')),
  });
