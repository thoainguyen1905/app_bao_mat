...
export const Cart = (props: any) => {
  ...
  return (
    <View style={styles.container}>
      ...
      {infoCart.count !== 0 && token && (
        <AppText style={styles.txtTitle}>
          - {t('countCart').replace('count', infoCart?.count)}
        </AppText>
      )}
              ...
              return (
                <View
                  style={{
                    ...
                    flex: 1,
                    height: Device.height - Spacing.height50 - Spacing.height90,
                  }}
                >
                  <IconCart3
                  ...
                  />
                  <AppText style={styles.txtTitleEmpty}>
                    {t('empty_cart')}
                  </AppText>
                  <AppText style={styles.txtDesEmpty}>
                    {t('how_to_choice')}
                  </AppText>
                  <AppButton
                    style={styles.btn}
                    label={t('shop_now')}
                    onPress={() =>
                      NavigationUtils.navigate(SCREEN_ROUTE.HOME_PAGE)
                    }
                  />
                </View>
              );
          ...
          {infoCart?.count !== 0 && (
            <View style={styles.viewBottom}>
              <AppText style={styles.txtPrice}>
                {t('txt_price') + ' ' + renderPrice(infoCart?.total)}
              </AppText>
              <AppButton
