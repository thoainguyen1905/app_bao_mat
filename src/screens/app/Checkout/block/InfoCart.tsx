...
export const InfoCart =(props:InfoCartType)=>{
        ...
        return(
            <TouchableOpacity style={styles.viewCart}>
               ...
               <View style={{marginLeft:8}}>
                   <AppText style={{fontWeight:'500'}} numberOfLines={2}>{item?.product?.name}</AppText>
                   ...
                   <AppText style={{fontSize:FontSize.Font12,fontWeight:'500'}}>x{item?.quantity}  <AppText style={{fontSize:FontSize.Font12,color:Colors.red,fontWeight:'500'}}>{renderPrice(item?.product?.price)}</AppText></AppText>
               </View>
            </TouchableOpacity>
        )
    }
    return(
        <View style={styles.containerAddress}>
            ...
            <AppText style={styles.txtCountPrice}>({products?.length+" "+t("product")})</AppText>
            ...
            <View style={{borderTopColor:Colors.borderColor,borderTopWidth:1}}>
                ...
                <View style={{...styles.viewRow,marginTop:12}}>
                    ...
                    <View style={{backgroundColor:Colors.colorMain2,padding:16,borderRadius:8}}>
                        <AppText style={{...styles.txtTitle,fontSize:FontSize.Font18,color:Colors.white}}>{renderPrice(total)}</AppText>
                    </View>
                </View>
            </View>
        </View>
